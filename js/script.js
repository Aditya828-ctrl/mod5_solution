...
$ajaxUtils.sendGetRequest(
  ...
  true);
  console.log("Hi"); // Explicitly setting the flag to get JSON from server processed into an object literal
});
// *** finish **
...
console.log(categories);
  ...
  $ajaxUtils.sendGetRequest(
    homeHtmlUrl,
    function (homeHtml) {console.log("hi");console.log(homeHtml);
